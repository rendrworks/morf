...
function field.new(options)
  ...
  counter = counter + 1
  local self = {
    text = morf.signal("chillpill.field." .. counter .. ".text", ""),
    focused = morf.signal("chillpill.field." .. counter .. ".focused", true),
    options = options,
  }
...
function field.node(self, values)
  ...
  local blink = morf.signal("chillpill.field.blink." .. tostring(self), true)
