...
-- Alpha low enough that the blur is the subject and the colour is a hint. `26`
-- of 255 is about a tenth — enough to tell the blobs apart, not enough to be
-- the thing you are looking at.
local BLOBS = {
  { radius = 0.150, orbit = 0.185, speed = 0.00040, phase = 0.0, wobble = 0.052, color = "#f0b47a26" },
  { radius = 0.122, orbit = 0.225, speed = -0.00057, phase = 1.9, wobble = 0.066, color = "#e8735a2e" },
  { radius = 0.104, orbit = 0.152, speed = 0.00079, phase = 3.4, wobble = 0.038, color = "#b4e1ea2a" },
  { radius = 0.088, orbit = 0.248, speed = -0.00098, phase = 5.0, wobble = 0.074, color = "#7fb7c930" },
  { radius = 0.074, orbit = 0.118, speed = 0.00121, phase = 2.4, wobble = 0.044, color = "#f5d98b2c" },
  { radius = 0.062, orbit = 0.272, speed = -0.00142, phase = 0.7, wobble = 0.058, color = "#c98fd132" },
}
...
field.fill_color = "#f0b47a26"
-- A thin bright edge. Where the glass ends is the one place it should be
-- legible, and a blurred shape with no rim reads as a smudge.
field.stroke_color = "#ffffff3a"
